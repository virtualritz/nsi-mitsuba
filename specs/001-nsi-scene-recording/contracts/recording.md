...
| --- | --- | --- | --- | --- |
| `Recorder` satisfies the full `Nsi` bound | Covered | `crates/nsi-record/src/recorder.rs` `impl Nsi for Recorder` | `recorder::tests::recorder_implements_nsi` | -- |
...
- `cargo test -p nsi-record --lib owned`
- `cargo test -p nsi-record --lib recorder`
- `cargo test -p nsi-record --lib scene`
